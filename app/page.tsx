export default function Home() {
  return (
    <main className="mx-auto max-w-screen-md space-y-24">
      ...
      <section id="features" className="space-y-8">
        ...
        <article className="space-y-2">
          ...
          <p>
            ...
            aspernatur adipisci blanditiis asperiores officia corporis, ex
            aliquid dolorum esse suscipit molestiae ab excepturi sit quaerat.
          </p>
        </article>
        ...
        <article className="space-y-2">
          ...
          <p>
            ...
            dolores, repudiandae mollitia, voluptate consequuntur architecto
            ullam explicabo inventore odio quo nihil id possimus exercitationem
            pariatur laborum illum cumque nam doloremque! Reiciendis recusandae
            impedit distinctio?
          </p>
        </article>
        <article className="space-y-2">
      ...
      <section
        ...
        className="space-y-4 max-w-screen-sm mx-auto text-center"
      >
        <h2>Updates</h2>
